    ...
    <Router>
      <div>
        ...
        <div className="w-full flex justify-evenly">
          <h1
            className={`m-2 px-8 py-3 w-full text-white rounded-md text-xl text-center transition-all duration-500 
        ...
        <Routes>
            ...
            element={
              <div className="text-center mt-10">
                ...
                <p className="text-gray-600">
                  Please navigate to the registration page to create an account.
                </p>
              </div>
            }
          />
          ...
          <Route
            path="/register"
            element={<Login setData={setData} data={data} />}
          />
        </Routes>
      </div>
    </Router>
